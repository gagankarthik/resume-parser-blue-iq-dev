...
- A degree "in progress" (e.g. "MSN in progress / expected 2027", "BSN, Candidate May 2026", "current student") IS included; put the expected year in graduation_year only if a year is given, else leave it null. Never drop an in-progress degree, and set `in_progress: true` on it. For a completed degree leave `in_progress` false.
